...
const {markAttendance,markAbsent, markPresent,getAllAttendanceByDate,getAllAttendanceByStudentId, getAllAttendance, getConsolidatedAttendance, GenerateAttendanceXlsx, GenerateAttendanceConsolidated} = require('../controllers/attendance.controller')
